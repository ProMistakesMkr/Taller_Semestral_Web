...
filter_tipo_prenda.addEventListener("change", (e) => {
    filtrado()
});
filter_tipo_material.addEventListener("change", (e) => {
    filtrado()
});
filter_tipo_seccion.addEventListener("change", (e) => {
    filtrado()
});
filter_tipo_sexo.addEventListener("change", (e) => {
    filtrado()
});
